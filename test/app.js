...
const APP_VERSION='TEST V0.0.51.0';
...
const openAppointments=()=>state.orders.filter(o=>!o.archived&&o.status!=='Abgeschlossen'&&o.fulfilmentDate).sort((a,b)=>a.fulfilmentDate.localeCompare(b.fulfilmentDate)||String(a.number).localeCompare(String(b.number),'de-CH'));
