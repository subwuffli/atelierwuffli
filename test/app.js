...
const APP_VERSION='TEST V0.0.57.0';
...
orderForm=async function(id){
  ...
  if(form){
    ...
    customerField?.insertAdjacentHTML('afterend',`<div id="new-customer-panel" class="span-2 inline-create-panel hidden"><div class="inline-create-head"><strong>Neuen Kunden erfassen</strong><button type="button" class="text-button" id="cancel-new-customer">Schliessen</button></div><div class="form-grid compact-grid"><label>Firma<input id="inline-company"></label><label>Anrede<input id="inline-salutation"></label><label>Vorname<input id="inline-first-name"></label><label>Nachname<input id="inline-last-name"></label><label>E-Mail<input id="inline-email" type="email"></label><label>Telefon<input id="inline-phone" type="tel"></label><label class="span-2">Strasse / Rechnungsadresse<input id="inline-street"></label><label>PLZ<input id="inline-zip" inputmode="numeric"></label><label>Ort<input id="inline-city"></label></div><div id="inline-customer-error" class="error small"></div><div class="actions inline-create-actions"><button type="button" class="primary" id="save-new-customer">Kunden speichern und auswählen</button></div></div>`);
