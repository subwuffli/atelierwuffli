...
const LIST_COLUMN_OPTIONS={customers:[['number','Kundennummer'],['name','Kunde'],['contact','Kontakt'],['address','Adresse']],orders:[['number','Auftragsnummer'],['customer','Kunde'],['dates','Art / Termin'],['status','Status'],['total','Betrag']],invoices:[['number','Rechnungsnummer'],['customer','Kunde'],['due','Fällig am'],['status','Status'],['total','Betrag']],receipts:[['number','Quittungsnummer'],['invoice','Rechnung'],['customer','Kunde'],['date','Datum'],['total','Betrag']]};
...
const userPreferences=()=>({customerSort,orderSort,invoiceSort,receiptSort,financeMonth,listColumns});
