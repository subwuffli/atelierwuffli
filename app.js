...
async function pdfDocument(type,id){
  ...
  if(isInv||isReceipt){
    ...
    const decorate=()=>{doc.setFillColor(249,241,240);doc.rect(0,0,210,297,'F');doc.setDrawColor(...roseStrong);doc.setLineWidth(.35);doc.roundedRect(7,7,196,283,3,3,'S')};
